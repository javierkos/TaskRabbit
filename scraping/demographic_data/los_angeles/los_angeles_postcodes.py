...
# Find zip codes
def find_zips():
    google_zips = ZipScraper("los angeles")
...
def second_part():
    ...
    with open("data/temp_data_2.json", "w") as write_file:
        json.dump(census_scraper.income_tab(postcode_info), write_file)

def third_part():
    global postcode_list

    with open("data/temp_data_2.json", "r") as read_file:
        postcode_info = json.load(read_file)
    with open("data/temp_data_3.json", "w") as write_file:
        json.dump(census_scraper.housing_tab(postcode_info), write_file)

def fourth_part():
    global postcode_list

    with open("data/temp_data_3.json", "r") as read_file:
        postcode_info = json.load(read_file)
    ...
    with open("data/temp_data_4.json", "w") as write_file:
        json.dump(postcode_info, write_file)

def fifth_parth():
    with open("data/temp_data_4.json", "r") as read_file:
        postcode_info = json.load(read_file)
    ...
    with open("data/temp_data_5.json", "w") as write_file:
        json.dump(postcode_info, write_file)

def sixth_part():
    with open("data/temp_data_5.json", "r") as read_file:
        postcode_info = json.load(read_file)
